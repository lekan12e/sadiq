...
const Explore = () => {
  const [toggleDevices, setToggleDevices] = useState(true);
      ...
      <div className='flex flex-col justify-start items-start'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 gap-2 max-w-full'>
          <Link to='/apple' className='flex justify-center items-center'>
            <img onClick={hideIphone} className='w-full max-w-[60px] sm:max-w-[80px] md:max-w-[100px]' src={apple} alt='apple_category' />
          </Link>
          <Link to="/samsung" className='flex justify-center items-center'>
            <img onClick={hideIphone} className='w-full max-w-[60px] sm:max-w-[80px] md:max-w-[100px]' src={samsung} alt='samsung_category' />
          </Link>
          <Link to="/jbl" className='flex justify-center items-center'>
            <img onClick={hideIphone} className='w-full max-w-[60px] sm:max-w-[80px] md:max-w-[100px]' src={JBL} alt='jbl_category' />
          </Link>
          <Link to='/ps' className='flex justify-center items-center'>
            <img onClick={hideIphone} className='w-full max-w-[60px] sm:max-w-[80px] md:max-w-[100px]' src={PS} alt='ps_category' />
          </Link>
        </div>
      </div>
      <div className='pt-10'>
        <Outlet />
        {toggleDevices && <Iphone />}  
      </div>
    </div>
  );
};
